...
import { LogOut, Settings, Home, FileText, Users, BarChart3, MessageSquare, BookOpen, Menu, Zap, Handshake, Lightbulb, Share2, Award, UserPlus, ShieldAlert, DollarSign, Star, Trophy } from "lucide-react"; 
...
const navLinksConfig = [
  ...
  { href: "/offers/business-leads", label: "Premium Business Contacts", icon: <BarChart3 />, isPremium: true },
    ...
    <Sheet>
      ...
      <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 flex flex-col">
        <SheetHeader className="p-4 border-b">
           <Link href="/offers/home" className="flex items-center gap-2 mb-1">
