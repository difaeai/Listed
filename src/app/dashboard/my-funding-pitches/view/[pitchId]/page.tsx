...
import { ArrowLeft, Eye, Users, DollarSign, Briefcase, FileText, Mail, CalendarDays, BarChartHorizontalBig, Edit, ImageIcon, MessageSquare, XCircle, Package, Zap as ZapIcon, Info as InfoIcon, ThumbsUp, ThumbsDown, Percent } from 'lucide-react';
          ...
          {offer.pitchImageUrl && (
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-2 flex items-center">
               ...
               <NextImage src={offer.pitchImageUrl} alt={offer.projectTitle} width={800} height={450} className="rounded-md object-contain mx-auto border" data-ai-hint="project image large"/>
            </div>
          )}
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Card className="shadow-sm cursor-pointer hover:shadow-md transition-shadow bg-blue-500/10 border-blue-500/30">
                  ...
                  <CardContent><p className="text-3xl font-bold">{offer.views || 0}</p><p className="text-xs text-muted-foreground">Total times this pitch was viewed by sales professionals.</p></CardContent>
                </Card>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader><DialogTitle>Pitch Viewers (Mock)</DialogTitle><DialogDescription>List of sales professionals who viewed this offer.</DialogDescription></DialogHeader>
